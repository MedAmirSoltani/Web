...
if (selected == "----") {
       ...
       document.getElementById("badelha").innerHTML = ' <p style="color: red; font-size: 20px; font-family: sans-serif; margin: 30px 10 0 20;" id="erreur">choose a role</p>';
       return false;
       preventdefault(); 
    }
    if (selected == "Etudiant") {
        ...
        if (classe ==false) {
           document.getElementById("badelha").innerHTML = ' <p style="color: red; font-size: 20px; font-family: sans-serif; margin: 30px 10 0 20;" id="erreur">write a class</p>';
           return false;
           preventdefault(); }
        }
    if (selected == "Prof") {
