...
$mysqli = mysqli_connect('localhost', 'root', '', 'presence');
$columns = array('Date','Heure');
...
if ($result = $mysqli->query('SELECT * FROM registre_appel ORDER BY ' .  $column . ' ' . $sort_order)) {
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Absences</h3>
          </div>
          <div class="content-header-right col-md-8 col-12">
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="back.php">Home</a>
                  </li>
