...
<section class="layout_padding section about_dottat">
 ...
 <form name="f1"  method="post" action="Modifiersa.php" enctype="multipart/form-data" >
...
?>
        <table id="example1" class="table table-striped">
          <tr>
            <th></th>
            <th><input type="hidden" name="id" value="<?php echo $res['Id']; ?>"/></th>
          </tr>
          <tr>
      <tr>
            <th>Nom</th>
            <th><input type="text" name="nom" value="<?php echo $res['nom']; ?>"/></th>
              <th><input type="hidden" name="id_blc" value="<?php echo $res['id_block']; ?>"/></th>
          </tr>

         <tr>
            <th>Nombre de projecteurs</th>
            <th><input type="number" name="nbrprj" value="<?php echo $res['Nbrprojecteurs']; ?>"/></th>
          </tr>
          ...
          <th><input type="number" name="nbrchais" value="<?php echo $res['Nbrchaises']; ?>" required/></th>
        </tr>
