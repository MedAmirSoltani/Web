...
$sql="SELECT * FROM salles where  nom=:nom OR Nbrprojecteurs=:nom OR Nbrtables=:nom OR Nbrchaises=:nom OR id_block=:nom ";
...
<section class="layout_padding section about_dottat">
 ...
 <div class="row">
              ...
              <a href="trinom.php"><li data-filter=".gra">Trie les  Nom</li></a> 
              <a href="ListeBlocks.php"><li data-filter=".gra">All</li></a> 
