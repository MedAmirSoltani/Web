<?php
    ...
    if (isset($_POST['idmatiere'] ) && isset($_POST['titre'] )) 
    {
            $matiere = new matiere($_POST['idmatiere'] , $_POST['titre'] );
						...
						<form action="" method="POST" onsubmit="return verif();" >
							<table class="table" border="1" align="center">
								<tr>
									...
									<td><input type="text" name="idmatiere" id="idmatiere" maxlength="20"></td>
								</tr>
								<tr>
									<td>
