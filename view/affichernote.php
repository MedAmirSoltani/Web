...
if (isset($_POST['search'])) {
  $list = $noteC->afficherbyname($_POST['search']);
}
?>
              ...
              <div class="card-content collapse show">
                <div class="card-body">
                  <div class="table-responsive">
                    <a href="ajouternote.php">Ajouter note </a>
                    <br>
                    ...
                    <table class="table" border='2'>
                      ...
                      ?>
                        ...
                        <tr>
                          <td><?php echo $key['idnote']; ?></td>
                          <td><?php echo $key['nom']; ?></td>
                          <td><?php echo $key['prenom']; ?></td>
                          <td><?php echo $key['notes']; ?></td>


                          <td><a href="supprimernote.php?idnote=<?php echo $key['idnote']; ?>&idmatiere=<?php echo $key['idmatiere']; ?>"><img src="../Assets/Images/supp.png" witdh='25px' height='25px'></a></td>
                          <td><a href="modifiernote.php?idnote=<?php echo $key['idnote']; ?>">modifier</a></td>
                        </tr>


                      <?php
                      }
                      echo ("students number=$i");
                      ?>
                    </table>
                  </div>
                </div>
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table" border='2'>
                      ...
                      ?>
                          ...
                          <tr>
                            <td><?php echo $lists['idnote']; ?></td>
                            <td><?php echo $lists['nom']; ?></td>
                            <td><?php echo $lists['prenom']; ?></td>
                            <td><?php echo $lists['notes']; ?></td>


                            <td><a href="supprimernote.php?idnote=<?php echo $lists['idnote']; ?>&idmatiere=<?php echo $key['idmatiere']; ?>"><img src="../Assets/Images/supp.png" witdh='25px' height='25px'></a></td>
                            <td><a href="modifiernote.php?idnote=<?php echo $lists['idnote']; ?>">modifier</a></td>
                          </tr>
