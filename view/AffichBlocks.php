                           ...
                           <div class="row">
                              ...
                              <div class="col">
                                 ...
                                 <?php if ($x["admin_bool"] == 1) { ?>
                                    ...
                                    <a href="ModifyBloc.php?idb=<?php echo $block['Id']; ?>"><input style=" cursor:pointer; background: #00ff00;border: none; border-radius: 30px; color: white;margin-bottom: 0.8em;" type="button" value="update" /></a>
                                 <?php } ?>
                              </div>
                           </div>
                        </div>
