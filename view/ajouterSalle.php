...
if (
  ...
  isset($_POST["nom"]) &&
  isset($_POST["nbrprj"]) &&
  isset($_POST["nmbrtabl"]) &&
  isset($_POST["nmbrchair"])
) {
  ...
  if (
    ...
    !empty($_POST['nom']) &&
    !empty($_POST["nbrprj"]) &&
    !empty($_POST["nmbrtabl"]) &&
    !empty($_POST["nmbrchair"])
  ) {
    $Salles = new Salles(
      $_POST["id"],
      $_POST["nom"],
                    ...
                    <form action="" method="POST" onsubmit="return verif();">
                      <table class="table" border="1" align="center">
                        ...
                        <tr>
                          ...
                          <th><input type="number" name="nmbrtabl" value="" required /></th>
                        </tr>
                        <tr>
                          <th> Nombre de Chaires</th>
                          <th><input type="number" name="nmbrchair" value="" required /></th>
                        </tr>
