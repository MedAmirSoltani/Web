                        ...
                        <div class="table-responsive">
                          <table class="table">
                            <thead class="thead-dark">
                              <tr>
                                <th scope="col"><label for="Id_absence">
                                    <font color="white">Id absence:</font>
                                  </label></th>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td><input type="date" value="<?php echo $a['Date_absence']; ?>" name="Date_absence" id="userdate" onchange="TDate()" required min="2021-01-01" max="2022-12-31"></td>
                                <td><input type="time" value="<?php echo $a['Heure_absence']; ?>" id="Heure_absence" name="Heure_absence" min="09:00" max="18:00" required></td>
                                <td>
