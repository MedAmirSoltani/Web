...
<body class="main-layout contact-page">
   ...
   <div class="Contact">
      <div class="container">
         <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
               <form id="formulaire" action="" method="POST" onsubmit="return getselectedvalue();" >
                  <div class="row">
                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                     <img style="width:40%;height:200px;border-radius:50%;float:center;margin:0 10px 0 450px;  " onclick="pictureclick()" id="profildisplay" width=200  src="uploads/<?php echo $x['profilpicture'];?>">
                     <br> <br> <br>
