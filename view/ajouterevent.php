...
<?php
    ...
    if (isset($_POST['nomevent'] ) && isset($_POST['date'] )&& isset($_POST['idclub'] )) 
    {
            $event = new event(NULL , $_POST['nomevent'] , $_POST['date'], $_POST['idclub']   );
            $eventC = new eventC();
            $eventC->ajouterevent($event);
            $id=$_POST['idclub'];
            header("Location:afficherevent.php?idclub=$id");
    }
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">             <span class="avatar avatar-online"><img src="theme-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span></a>
                <div class="dropdown-menu dropdown-menu-right">
                  <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online"><img src="theme-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><span class="user-name text-bold-700 ml-1">John Doe</span></span></a>
                    ...
                    <div class="dropdown-divider"></div><a class="dropdown-item" href="#"><i class="ft-power"></i> dateut</a>
                  </div>
                </div>
              </li>
            </ul>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">       
          <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-date" alt="Chameleon admin date" src="theme-assets/images/date/date.png"/>
			...
			<div class="card-content collapse show">
				<div class="card-body">
					<div class="table-responsive">
						...
						<form action="" method="POST" onsubmit="return verif();" >
							<table class="table" border="1" align="center">
								...
								<tr>
									<td>
										<label for="nomevent">event name:
										</label>
									</td>
									<td><input type="text" name="nomevent" id="nomevent" maxlength="20" required></td>
								</tr>
								<tr>
									<td>
                  ...
                  <tr>
									...
									<td><input type="date" name="date" id="date" maxlength="20" required></td>
								</tr>
								<tr>
									<td>
                  <tr>
									<td>
                  <label for="idclub">club:
                </label>
              </td>
              <td><select name="idclub" id="idclub" required>
                  <option value="">--Please choose an option--</option>
                    <?php foreach ($resultats as $value) {
                      ?>
    <option value="<?php echo($value["idclub"])?>"> <?php echo($value["nomclub"])?></option>
