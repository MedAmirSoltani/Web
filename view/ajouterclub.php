...
session_start();
    ...
    if (isset($_POST['nomclub'] ) && isset($_FILES['logo'] )) 
    {
            $club = new club(NULL , $_POST['nomclub'] , $_FILES['logo']["name"]);
            $clubC = new clubC();
			...
			<div class="card-content collapse show">
				<div class="card-body">
                  ...
                  <tr>
									...
									<td><input type="file" accept="image/*" name="logo" id="logo" maxlength="20" required></td>
								</tr>
								<tr>
									<td>
