	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">Modifier Reclamation Note</h4>
				...
				<div class="table-responsive">
					<table class="table">
						<thead class="thead-dark">
							<tr>
                            <th scope="col"><label for="Id_note"><font color="white">Id Registre:</font></label></th>
                                <th scope="col"><label for="Module"><font color="white">Id note:</font></label></th>
       ...
       <td><textarea name="Description" id="Description" value="<?php echo $a['Description'];?>"  cols="30" rows="5"></textarea></td>
