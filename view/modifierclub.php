...
session_start();
    ...
    if (isset($_POST['idclub'] ) && isset($_POST['nomclub'])&& isset($_FILES['logo'])  ) 
    {
        echo $_POST['idclub'] ;
            $club = new club($_POST['idclub'] , $_POST['nomclub'], $_FILES['logo']["name"] );
		...
		<div class="card">
			...
			<div class="card-content collapse show">
                ...
                <tr>
                  ...
                  <input type="file" accept="image/*" value="<?php echo $a['logo'];?>" name="logo" id="logo" maxlength="20"></td>
								</tr>
