  ...
  session_start();
   ...
   $userC = new utilisateurC();
    ...
    if (isset($_POST['IdRegistre'] ) &&isset($_POST['Etudiant'] )&&isset($_POST['Module'] )&&isset($_POST['Date'] )&&isset($_POST['Heure'] )&&isset($_POST['Etat'] )) 
    {
            ...
            $registre_appelC->ajouterRegistre_appel($registre_appel);
   ...
   <div class="Contact">
	...
	<div class="col-12">
				...
				<div class="table-responsive">
					<table class="table">
						<thead class="thead-dark">
							<tr>
                            <th scope="col"><label for="IdRegistre"><font color="white">Id Registre:</font></label></th>
                                ...
                                <th scope="col"><label for="Date"><font color="white">Date d'Absence:</font></label></th>
                                <th scope="col"><label for="Heure"><font color="white">Heure d'Absence:</font></label></th>
       ...
       <td><select type="text" name="Etudiant" id="Etudiant">
                    ...
                    <td><input type="date" name="Date" id="userdate" onchange="TDate()" required 
