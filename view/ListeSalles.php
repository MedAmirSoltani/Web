...
$SallesC = new SallesC();
$listeSalless = $SallesC->afficherSalles();
?>
<html lang="en">
<!-- Basic -->
<meta charset="utf-8">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $Salles['Nbrtables']; ?></td>
                                                            <td><?php echo $Salles['Nbrchaises']; ?></td>
                                                            <td>
                                                                <form method="POST" action="ModifierSalles.php">
                                                                    <input type="submit" name="Modifier" value="Modifier">
                                                                    <input type="hidden" value=<?PHP echo $Salles['Id']; ?> name="id">
                                                                </form>
                                                            </td>
                                                            <td>
                                                                <a href="SupprimerSalles.php?Id=<?php echo $Salles['Id']; ?>"><button>Supprimer</button></a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="full center">
                                    <a class="blue_bt" href="contact1.html">contact us</a>
                                    <a class=" blue_bt" href="AjouterSalles.php">Ajouter Salles</a>
                                </div>
                            </div>
                        </div>
                    </div>
