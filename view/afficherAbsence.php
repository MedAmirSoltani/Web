				...
				<div class="table-responsive">
					<table class="table">
						<thead class="thead-dark">
							<tr>
								<th scope="col"><label for="Id_reclamation"> <font color="black">Id reclamation</font>
								</label></th>
								<th scope="col"><label for="Module"><font color="black">Module </font></label></th>
                        <th scope="col"><label for="Date_absence"><font color="black">Date d'absence </font></label></th>
                        <th scope="col"><label for="Heure_absence"><font color="black">Heure d'absence </font></label></th>
