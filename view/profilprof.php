...
<body class="main-layout home_page">
   ...
   <section class="slider_section">
     ...
     <br>
                                                 <div style="margin:0px 10px 0 825px; ">  <h2 style="color:white;"> <strong>Specialite: </strong> </h2>  <h2 style="margin:0px 10px 0 23px;color:white; "><?php echo $_SESSION['c']?>  </h2> </div>
     <br>
